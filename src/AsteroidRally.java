...
public class AsteroidRally {
	...
	public void draw() {
		...
		// new: Draw the score board
		StdDraw.setPenColor(StdDraw.RED);
		StdDraw.text(0.2, 0.95, "Red: " + model.getScore1());
		StdDraw.setPenColor(StdDraw.BLUE);
		StdDraw.text(0.8, 0.95, "Blue: " + model.getScore2());
		// Draw ship
	...
	public void titleScreen() {
		...
		StdDraw.text(0.5, 0.4, "Red player: maneuver with A/W/D. Press S to brake!");
		StdDraw.text(0.5, 0.3, "Blue player: maneuver with J/I/L. Press K to brake!");
